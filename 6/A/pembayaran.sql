...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 28 Des 2019 pada 13.04
...
ALTER TABLE `product`
  ...
  ADD CONSTRAINT `product_ibfk_2` FOREIGN KEY (`id_cashier`) REFERENCES `cashier` (`id_cashier`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
